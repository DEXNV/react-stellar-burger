    ...
    render(){
        return (
            <div className={styles.ingredientCard} /*onClick={() => this.addIngredient(this.props._id)}*/>
                <div className={styles.ingredientCounter}>{this.props.count !== 0  && this.props.count < 99 && <Counter count={this.props.count} size="default" extraClass="m-1"/>}
                {this.props.count !== 0  && this.props.count > 99 && <Counter count={this.props.count} size="small"/>}</div>
